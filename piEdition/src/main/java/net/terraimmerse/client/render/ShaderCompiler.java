...
public class ShaderCompiler {
    ...
    public ShaderCompiler(String vertexPath, String fragmentPath, String shaderName_){
    ...
    private String loadShader(String path){
        try (InputStream stream=ShaderCompiler.class.getResourceAsStream(path)){
            ...
            LOGGER.info("Loaded a shader file for "+this.shaderName);
    ...
    public int compileShader(String source, int shaderType){
        ...
        LOGGER.info("Compiled a shader file for "+this.shaderName);
        return shader;
    }
    public int createShaderProgram(String vertexSrc, String fragmentSrc){
        ...
        LOGGER.info("Created shader program for "+this.shaderName);
        return program;
    }
}
