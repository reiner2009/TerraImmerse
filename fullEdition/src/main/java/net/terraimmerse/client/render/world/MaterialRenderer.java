...
public class MaterialRenderer {
    public static float[] getVertices(int x, int y, int z, String material, Level level, Map<String, int[]> atlasData, int atlasW, int atlasH, Map<String, String[]> textureData) {
        ...
        for (int i = 0; i < faces.length; i++) {
            String neighborMaterial = level.getMaterial(
                    x + neighbors[i][0],
                    y + neighbors[i][1],
                    z + neighbors[i][2]
            );
